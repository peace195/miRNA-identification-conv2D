...
def perfeval(predictions, Y_test, verbose=0):
  ...
  if verbose == 1:
    print("ACC:", "{:.3f}".format(acc), "SE:", "{:.3f}".format(se), "SP:", "{:.3f}".format(sp), "F-Score:",
          "{:.3f}".format(f1), "PPV:", "{:.3f}".format(ppv), "gmean:", "{:.3f}".format(gmean), "AUROC:",
          "{:.3f}".format(auroc), "AUPR:", "{:.3f}".format(aupr))
